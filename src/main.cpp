...
static AudioLooper looper;
// Main code
int main(int, char**)
{ 
    // Setup SDL
    if (!SDL_Init(SDL_INIT_VIDEO | SDL_INIT_GAMEPAD | SDL_INIT_CAMERA | SDL_INIT_SENSOR | SDL_INIT_JOYSTICK | SDL_INIT_AUDIO | SDL_INIT_HAPTIC))
    {
